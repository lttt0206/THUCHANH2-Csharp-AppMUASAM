...
namespace MUASAM
{
    public partial class YeuthichUI : KryptonForm
    {
        string strNhan;
        public YeuthichUI()
        {
            ...
            XemthemYeuThich ct = new XemthemYeuThich();
            int i = 1;
            ...
            int tmp2 = 8;
                if (list.Count > tmp2)
                {
                    ...
                    tmp += 570;
                    tmp2 += 8;
                XemthemYeuThich ct3 = new XemthemYeuThich();
                    ...
                    if (list.Count > tmp2)
                    {
                        ...
                        tmp += 570;
                        tmp2 += 8;
                    XemthemYeuThich ct4 = new XemthemYeuThich();
                        ...
                        if (list.Count > tmp2)
                        {
                            ...
                            tmp += 570;
                            tmp2 += 8;
                        XemthemYeuThich ct5 = new XemthemYeuThich();
                            ...
                            if (list.Count > tmp2)
                            {
                                ...
                                tmp += 570;
                                tmp2 += 8;
                            XemthemYeuThich ct6 = new XemthemYeuThich();
                                ...
                                if (list.Count > tmp2)
                                {
                                    ...
                                    tmp += 570;
                                    tmp2 += 8;
                                XemthemYeuThich ct7 = new XemthemYeuThich();
                                    ...
                                    if (list.Count > tmp2)
                                    {
                                        ...
                                        tmp += 570;
                                        tmp2 += 8;
                                    XemthemYeuThich ct8 = new XemthemYeuThich();
                                        ...
                                        if (list.Count > tmp2)
                                        {
                                            ...
                                            tmp += 570;
                                            tmp2 += 8;
                                        XemthemYeuThich ct9 = new XemthemYeuThich();
                                            ...
                                            if (list.Count > tmp2)
                                            {
                                                ...
                                                tmp += 570;
                                                tmp2 += 8;
                                            XemthemYeuThich ct10 = new XemthemYeuThich();
                                                ...
                                                if (list.Count > tmp2)
                                                {
                                                    ...
                                                    tmp += 570;
                                                    tmp2 += 8;
                                                XemthemYeuThich ct11 = new XemthemYeuThich();
                                                    ...
                                                    if (list.Count > tmp2)
                                                    {
                                                        ...
                                                        tmp += 570;
                                                        tmp2 += 8;
                                                    XemthemYeuThich ct12 = new XemthemYeuThich();
                                                        ...
                                                        if (list.Count > tmp2)
                                                        {
                                                            ...
                                                            tmp += 570;
                                                            tmp2 += 8;
                                                        XemthemYeuThich ct13 = new XemthemYeuThich();
                                                            ct5.Message = i.ToString();
                                                            i += 8;
                                                            ct13.TopLevel = false;
                                                            ...
                                                            if (list.Count > tmp2)
                                                            {
                                                                ...
                                                                tmp += 570;
                                                                tmp2 += 8;
                                                            XemthemYeuThich ct14 = new XemthemYeuThich();
                                                                ...
                                                                if (list.Count > tmp2)
                                                                {
                                                                    ...
                                                                    tmp += 570;
                                                                    tmp2 += 8;
                                                                XemthemYeuThich ct15 = new XemthemYeuThich();
