...
namespace MUASAM
{
    public partial class Thoitrangnam : KryptonForm
    {
        public Thoitrangnam()
        {
            InitializeComponent();
            Xuly_Data s = new Xuly_Data();
            List<Sanpham> list = s.sqlGetSanpham("Thoitrangnam");
            panel2.Size = new Size(758, 564);
            Xemthem ct = new Xemthem();
            int i = 1;
            ct.Message = "Thoitrangnam-" + i;
            i += 8;
            ct.TopLevel = false;
