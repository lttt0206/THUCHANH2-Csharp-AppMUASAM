...
namespace MUASAM
{
    public partial class Mypham : KryptonForm
    {
        public Mypham()
        {
            ...
            List<Sanpham> list = s.sqlGetSanpham("Mypham");
